...
export default function Regnavbar() {
  ...
  return (
    <div className='bg-BboxColor w-full fixed shadow-[#000_0px_104px_2008px,#000_0px_100px_1000px] border-b-2 border-slate-800'>
      <div className='px-[30px] xl:px-[50px] 2xl:px-[100px] 15xl:px-0 w-full 15xl:w-[1320px] 2xl:w-[1450px] m-auto py-[10px] qsm:py-[13px] hsm:py-[15px] md:py-[17px] flex items-center justify-between'>
        <a href="/" className='flex items-center'>
          <img src={LogoICon} className='w-[40px] md:w-[50px]' alt="My Logo" />
        </a>

        <div className='flex items-center justify-end gap-[25px] md:gap-[50px]'>
          <a target='_blank' href="https://t.me/jasurkhaitov" className='hidden w-[55px] h-[55px] sm:flex items-center justify-center rounded-[10px] delay-150 hover:bg-[rgba(64,86,139,0.4)]'>
          ...
          <button className={`${style.buttonStyle} hidden`} onClick={():void => handleModal()}>
          ...
          <button className='block sm:hidden' onClick={():void => handleModal()}>
            <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 15 15"><path fill="white" d="M5 5.5a2.5 2.5 0 1 1 5 0a2.5 2.5 0 0 1-5 0"/><path fill="white" fill-rule="evenodd" d="M7.5 0a7.5 7.5 0 1 0 0 15a7.5 7.5 0 0 0 0-15M1 7.5a6.5 6.5 0 1 1 10.988 4.702A3.5 3.5 0 0 0 8.5 9h-2a3.5 3.5 0 0 0-3.488 3.202A6.482 6.482 0 0 1 1 7.5" clip-rule="evenodd"/></svg>
          </button>
        </div>
      </div>
        
      <dialog id="my_modal_3" className="modal bg-black bg-opacity-60">
        <div className="modal-box px-[15px] sm:px-[30px] pt-10 qsm:py-10 bg-BboxColor shadow-[#000_0px_14px_20px,#000_0px_10px_10px]">
          <form method="dialog" id='regForm' className='flex flex-col gap-5 qsm:gap-7 mb-2 border-b pb-[20px] qsm:pb-[30px] border-white'>
            ...
            <label htmlFor="email" className='flex flex-col gap-1 text-white text-button'>
              <div className='w-full flex items-end justify-between'>
                ...
                <span id='errorEmail' className='mr-2 qsm:mr-5 text-sm text-transparent'>*Enter email</span>
              </div>
            ...
            <label htmlFor="password" className='flex flex-col gap-1 text-white text-button'>
              <div className='w-full flex items-end justify-between'>
                ...
                <span id='errorPassword' className='mr-2 qsm:mr-5 text-sm text-transparent'>*Enter password</span>
              </div>
          ...
          <button id='nextBtn' onClick={handleSubmit} className={ !className ? `${style.buttonNoneActive} mb-3 qsm:mb-6` : `${style.buttonActive } mb-6`}>Submit</button>
          ...
          <button className={`${style.buttonModal}`}>
            ...
            <span className='text-white text-base qsm:text-button font-normal'>Sign in with Google</span>
          </button>
        </div>
      </dialog>
    </div>
